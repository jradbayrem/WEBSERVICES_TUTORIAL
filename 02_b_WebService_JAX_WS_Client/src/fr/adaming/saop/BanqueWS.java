 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://saop.adaming.fr/", wsdlLocation = "http://localhost:8880/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://saop.adaming.fr/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/BanqueWS?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://saop.adaming.fr/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://saop.adaming.fr/", "BanqueServicePort"), BanqueService.class, features);
    }
